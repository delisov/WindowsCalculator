...
namespace CalcDmitriyElisov.Views
{
    ...
    public class AcrylicWindow : Window
    {
        ...
        static AcrylicWindow()
        {
            ...
            FallbackColorProperty = AcrylicElement.FallbackColorProperty.AddOwner(typeof(AcrylicWindow), new FrameworkPropertyMetadata(Colors.DarkGray, FrameworkPropertyMetadataOptions.Inherits));
        ...
        internal static void EnableBlur(Window win)
        {
            ...
            if (currentVersion >= new VersionInfo(10, 0, 17763))
            {
                accent.AccentState = AccentState.ACCENT_ENABLE_ACRYLICBLURBEHIND;
            }
            else if (currentVersion >= new VersionInfo(10, 0, 10240))
            {
            ...
            accent.GradientColor = 0x99ebebeb;
        ...
        private static void OnEnableChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (value)
            {
                var dic = new ResourceDictionary() { Source = new Uri("pack://application:,,,/CalcDmitriyElisov;component/Styles/Window.xaml") };
